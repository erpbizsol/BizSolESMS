...
$(document).ready(function () {
    ...
    if (BMode === 'Edit') {
        $.ajax({
            url: `${appBaseURL}/api/Master/ShowItemByCode?Code=` + BCode,
            type: 'GET',
...
function CreateItemMaster() {
    window.location.href = '/Master/CreateItemMaster?Mode=New';
...
function Edit(code) {
    window.location.href = `/Master/CreateItemMaster?Code=${code}&Mode=Edit`;
}

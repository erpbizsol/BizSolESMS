...
function BoxValidationDetail(Check) {
    ...
    $.ajax({
        url: `${appBaseURL}/api/MRNMaster/GetBoxValidateDetailWithoutBox`,
        type: 'POST',
...
function MRNDetail() {
    $.ajax({
        url: `${appBaseURL}/api/MRNMaster/GetMRNDetailForValidateWithoutBox`,
        type: 'GET',
        contentType: "application/json",
        dataType: "json",
        beforeSend: function (xhr) {
